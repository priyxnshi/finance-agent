      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 pt-16 pb-24 lg:pt-24 lg:pb-32 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 mb-6">
            ...
            <span className="text-2xs font-medium text-ledger-secondary">Your AI finance agent, not another bank</span>
          </div>
          ...
          <p className="mt-6 text-lg text-ledger-secondary leading-relaxed max-w-md">
          ...
          <p className="mt-8 text-2xs text-ledger-tertiary">
