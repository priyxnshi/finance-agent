      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 grid lg:grid-cols-2 gap-14 items-center">
        <div className="order-2 lg:order-1 rounded-card border border-white/10 bg-ink-900 shadow-panel p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-2xs text-ledger-tertiary flex items-center gap-1 mt-0.5">
          ...
          <div className="flex items-center justify-between text-sm mb-6">
            ...
            <span className="ledger-num text-ledger-tertiary">of ₹{target.toLocaleString('en-IN')}</span>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-md border border-white/10 bg-ink-850 p-3.5">
              <div className="flex items-center gap-1.5 mb-1.5 text-ledger-tertiary">
                <TrendingUp size={12} />
