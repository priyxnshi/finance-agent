      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 pt-16 pb-24 lg:pt-24 lg:pb-32 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-3 py-1 mb-6">
            ...
            <span className="text-2xs font-medium text-ledger-dark-secondary">Your AI finance agent, not another bank</span>
          </div>

          <h1 className="font-display font-semibold text-4xl sm:text-5xl lg:text-[3.25rem] leading-[1.08] tracking-tight">
            Meet your personal finance agent.
          </h1>

          <p className="mt-6 text-lg text-ledger-dark-secondary leading-relaxed max-w-md">
          ...
          <p className="mt-8 text-2xs text-ledger-dark-tertiary">
