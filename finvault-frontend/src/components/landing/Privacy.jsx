      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 grid lg:grid-cols-2 gap-14 items-center">
        <div>
          ...
          <ul className="mt-6 space-y-3">
            <li className="flex items-start gap-2.5 text-sm text-ledger-dark-secondary">
        ...
        <div className="rounded-card border border-white/10 bg-ink-900 shadow-panel p-8">
          <div className="grid grid-cols-3 gap-4">
            {devices.map(({ icon: Icon, label }) => (
              <div key={label} className="flex flex-col items-center gap-2">
                ...
                <p className="text-2xs text-ledger-dark-tertiary">{label}</p>
              </div>
            ))}
          </div>

          <div className="flex flex-col items-center gap-1.5 my-5">
            <ArrowDown size={16} className="text-ledger-dark-tertiary" />
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-2xs text-ledger-dark-tertiary text-center max-w-[220px]">
          ...
          <div className="mt-6 pt-5 border-t border-white/[0.06] flex items-center justify-center gap-2">
            ...
            <span className="text-2xs text-ledger-dark-tertiary">Never transfer raw financial data</span>
          </div>
        </div>
      </div>
    </section>
