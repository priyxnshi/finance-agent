    ...
    <div className="relative">
      ...
      <div className="rounded-card border border-white/10 bg-ink-900 shadow-panel overflow-hidden">
        <div className="h-10 flex items-center gap-1.5 px-4 border-b border-white/[0.06] bg-ink-850">
          ...
          <span className="ml-3 text-2xs text-ledger-dark-tertiary">finvault.app/dashboard</span>
        </div>

        <div className="p-5 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-2xs uppercase tracking-wider text-ledger-dark-tertiary">Balance Trend</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-md border border-white/10 bg-ink-850 p-3">
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <p className="text-2xs text-ledger-dark-tertiary">Japan Trip Goal</p>
              </div>
              <div className="h-1.5 rounded-full bg-white/10 overflow-hidden">
                <div className="h-full w-[53%] rounded-full bg-signal-blue" />
              </div>
              <p className="ledger-num text-xs mt-1.5 text-ledger-dark-secondary">₹96,200 of ₹1,80,000</p>
            </div>
            ...
            <div className="rounded-md border border-white/10 bg-ink-850 p-3 flex items-center gap-3">
              ...
              <div>
                <p className="text-2xs text-ledger-dark-tertiary leading-tight">Financial Health Score</p>
          ...
          <div className="flex items-start gap-2.5 rounded-md border border-vault/20 bg-vault/[0.06] p-3">
            ...
            <p className="text-xs text-ledger-dark-secondary leading-relaxed">
              You could save an extra <span className="text-ledger-dark-primary font-medium">₹2,400/month</span> by
      ...
      <div className="hidden sm:flex absolute -left-8 top-10 items-center gap-2.5 rounded-md border border-white/10 bg-ink-900/95 backdrop-blur px-3.5 py-2.5 shadow-panel">
        ...
        <div>
          <p className="text-2xs text-ledger-dark-tertiary">Goal completion</p>
      ...
      <div className="hidden sm:flex absolute -right-6 -bottom-6 items-center gap-2.5 rounded-md border border-white/10 bg-ink-900/95 backdrop-blur px-3.5 py-2.5 shadow-panel">
        ...
        <div>
          <p className="text-2xs text-ledger-dark-tertiary">AI agent active</p>
          <p className="text-xs font-medium text-ledger-dark-primary">Watching 6 categories</p>
        </div>
      </div>
    </div>
  )
